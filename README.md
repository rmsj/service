...
[![InsightsSnapshot](https://dl.circleci.com/insights-snapshot/gh/rmsj/service/master/workflow/badge.svg)](https://app.circleci.com/insights/github/rmsj/service/workflows/workflow/overview?branch=master)
...
[Wiki](https://github.com/rmsj/service/wiki) | [Course Outline](https://github.com/rmsj/service/wiki/course-outline) | [Class Schedule](https://www.ardanlabs.com/events/)
...
* [Create Your Own Version](https://github.com/rmsj/service?tab=readme-ov-file#create-your-own-version)
* [Running The Project](https://github.com/rmsj/service?tab=readme-ov-file#running-the-project)
* [Purchase Video](https://github.com/rmsj/service?tab=readme-ov-file#purchase-video)
* [Experience](https://github.com/rmsj/service?tab=readme-ov-file#our-experience)
* [Teacher](https://github.com/rmsj/service?tab=readme-ov-file#our-teacher)
* [More About Go](https://github.com/rmsj/service?tab=readme-ov-file#more-about-go)
* [Minimal Qualified Student](https://github.com/rmsj/service?tab=readme-ov-file#minimal-qualified-student)
* [Joining the Go Slack Community](https://github.com/rmsj/service?tab=readme-ov-file#joining-the-go-slack-community)
...
$ mkdir code
$ cd code
$ git clone https://github.com/rmsj/service or git@github.com:rmsj/service.git
$ cd service
```
...
$ mkdir code
$ cd code
$ gonew github.com/rmsj/service github.com/mydomain/myproject
$ cd myproject
$ go mod vendor
```
